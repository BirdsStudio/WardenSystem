...
public class WardenAPI {
    ...
    public static void ban(CommandSender operator, String player, String reason, long expire){
        ...
        banCfg.save();
        MainClass.log.log(Level.INFO, operator.getName()+"执行：/warden ban "+player);
    ...
    public static void unban(CommandSender operator, String player){
        ...
        if(banned1.contains(player)){
            ...
            MainClass.log.log(Level.INFO, "CONSOLE执行：/warden unban "+player);
        }else{
    ...
    public static void mute(CommandSender operator, String player, String reason, long expire){
        ...
        muteCfg.save();
        operator.sendMessage("§a成功禁言玩家【"+player+"】\n解封时间:"+WardenAPI.getUnMutedDate(player)+"！");
        MainClass.muted.add(player);
        Player punished = Server.getInstance().getPlayer(player);
        if(punished != null){
            punished.sendMessage("您已被禁言");
        }
        MainClass.log.log(Level.INFO, "CONSOLE执行：/warden mute "+player);
        // 向所有在线玩家广播封禁消息
    ...
    public static void warn(CommandSender operator, String player){
        ...
        if(to != null){
            ...
            MainClass.log.log(Level.INFO, "CONSOLE执行：/warden warn "+player);
    ...
    public static void kick(CommandSender sender, String player){
        ...
        if(kicked != null){
            ...
            MainClass.log.log(Level.INFO, "CONSOLE执行：/warden kick "+player);
        }else{
    ...
    public static void suspect(CommandSender operator, String player, String reason, long expire){
        ...
        map.put(player+".operator", operator.getName());
        map.put(player+".reason", reason);
        ...
        MainClass.log.log(Level.INFO, "["+operator.getName()+"] 成功添加嫌疑玩家 ["+player +"]");
